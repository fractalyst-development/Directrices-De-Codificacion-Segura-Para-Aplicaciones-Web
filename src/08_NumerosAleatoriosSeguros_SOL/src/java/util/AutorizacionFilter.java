...
@WebFilter(filterName = "AutorizacionFilter", urlPatterns = {"/adminRoles.do"})
public class AutorizacionFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("AutorizacionFilter:DoBeforeProcessing");
        }
        Usuario u = (Usuario) request.getSession().getAttribute("usuario");
        ServiceFacade svc = new ServiceFacade();
        if (!svc.esAdmin(u.getNombre(), (List<Usuario>) request.getServletContext().getAttribute("usuariosDB"))) {
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("AutorizacionFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("AutorizacionFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("AutorizacionFilter: Initializing filter");
            }
        }
    }
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("AutorizacionFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("AutorizacionFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("AutorizacionFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("AutorizacionFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("AutorizacionFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
