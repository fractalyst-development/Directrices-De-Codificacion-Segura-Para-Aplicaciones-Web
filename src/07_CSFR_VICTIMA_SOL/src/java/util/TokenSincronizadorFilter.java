...
@WebFilter(filterName = "TokenSincronizadorFilter", urlPatterns = {"/adminRoles.do"})
public class TokenSincronizadorFilter implements Filter {
    ...
    public TokenSincronizadorFilter() {
    }

    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("TokenSincronizadorFilter:DoBeforeProcessing");
        }
        String tokenSincronizador = (String) request.getSession().getAttribute("tokenSincronizador");
        String tokenSincronizadorDesdeParametro = (request.getParameter("tokenSincronizador") == null ? "" : request.getParameter("tokenSincronizador"));
        if (!tokenSincronizador.equals(tokenSincronizadorDesdeParametro)) {
            request.getSession().setAttribute("mensaje", "SIN PERMISOS");
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("TokenSincronizadorFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("TokenSincronizadorFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("TokenSincronizadorFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("TokenSincronizadorFilter()");
        }
        StringBuffer sb = new StringBuffer("TokenSincronizadorFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("TokenSincronizadorFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("TokenSincronizadorFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("TokenSincronizadorFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("TokenSincronizadorFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("TokenSincronizadorFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
