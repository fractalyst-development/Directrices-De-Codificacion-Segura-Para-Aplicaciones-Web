...
import static util.log.MDCDemo.configureViaXML_File;

/**
 *
 */
@WebFilter(filterName = "BitacoratorFilter", urlPatterns = {"/*"})
public class BitacoratorFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("BitacoratorFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("BitacoratorFilter:DoAfterProcessing");
        }

        MDC.put("ip", request.getRemoteAddr());
        HttpSession session = request.getSession();
        //        Utils.toSHA1(session.getId());
        MDC.put("idsesion", session.getId());
        ...
        //
        Logger logger = LoggerFactory.getLogger(BitacoratorFilter.class);
        if (usuario.equals("Anónimo")) {
            logger.warn("AUTENTICACIÓN NO EXITOSA");
        } else {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("BitacoratorFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("BitacoratorFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("BitacoratorFilter()");
        }
        StringBuffer sb = new StringBuffer("BitacoratorFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("BitacoratorFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("BitacoratorFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("BitacoratorFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("BitacoratorFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("BitacoratorFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
